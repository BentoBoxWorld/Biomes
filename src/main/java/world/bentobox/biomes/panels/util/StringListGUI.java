...
public class StringListGUI
{
	...
	private void build()
	{
		PanelBuilder panelBuilder = new PanelBuilder().user(this.user).
			name(this.user.getTranslation("biomes.gui.title.admin.edit-text-fields"));
	...
	private PanelItem getButton(Button button)
	{
		...
		switch (button)
		{
			case SAVE:
			{
				...
				description = Collections.singletonList(this.user.getTranslation("biomes.gui.descriptions.admin.save"));
			...
			case CANCEL:
			{
				...
				description = Collections.singletonList(this.user.getTranslation("biomes.gui.descriptions.admin.cancel"));
			...
			case VALUE:
			{
				name = this.user.getTranslation("biomes.gui.buttons.admin.value");
				description = new ArrayList<>();
				description.add(this.user.getTranslation("biomes.gui.descriptions.current-value", "[value]", ""));
			...
			case ADD:
			{
				name = this.user.getTranslation("biomes.gui.buttons.admin.add-string");
			...
			case CLEAR:
			{
				name = this.user.getTranslation("biomes.gui.buttons.admin.clear");
				description = Collections.emptyList();
			...
			case REMOVE:
			{
				name = this.user.getTranslation("biomes.gui.buttons.admin.remove-empty");
				description = Collections.emptyList();
