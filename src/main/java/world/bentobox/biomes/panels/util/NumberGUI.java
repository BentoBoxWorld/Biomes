...
public class NumberGUI
{
	...
	private void build()
	{
		PanelBuilder panelBuilder = new PanelBuilder().user(this.user).name(this.user.getTranslation("biomes.gui.title.admin.manage-numbers"));
	...
	private PanelItem getButton(Button button)
	{
		...
		switch (button)
		{
			case SAVE:
			{
				...
				description = this.user.getTranslation("biomes.gui.descriptions.admin.save");
			...
			case CANCEL:
			{
				...
				description = this.user.getTranslation("biomes.gui.descriptions.admin.cancel");
			...
			case INPUT:
			{
				name = this.user.getTranslation("biomes.gui.buttons.admin.input");
				description = this.user.getTranslation("biomes.gui.descriptions.admin.input");
				icon = new ItemStack(Material.ANVIL);
				clickHandler = (panel, user, clickType, slot) -> {

					this.startConversion(number -> {
							this.value = number.intValue();
							this.build();
						},
						this.user.getTranslation("biomes.gui.questions.admin.number"));
			...
			case SET:
			{
				name = this.user.getTranslation("biomes.gui.buttons.admin.set-mode");
				description = this.user.getTranslation("biomes.gui.descriptions.admin.set-mode");
			...
			case INCREASE:
			{
				name = this.user.getTranslation("biomes.gui.buttons.admin.increase-mode");
				description = this.user.getTranslation("biomes.gui.descriptions.admin.increase-mode");
			...
			case REDUCE:
			{
				name = this.user.getTranslation("biomes.gui.buttons.admin.reduce-mode");
				description = this.user.getTranslation("biomes.gui.descriptions.admin.reduce-mode");
			...
			case MULTIPLY:
			{
				name = this.user.getTranslation("biomes.gui.buttons.admin.multiply-mode");
				description = this.user.getTranslation("biomes.gui.descriptions.admin.multiply-mode");
...
// ---------------------------------------------------------------------
	 ...
	 */
	private void startConversion(Consumer<Number> consumer, @NonNull String question)
	{
		...
		Conversation conversation =
			new ConversationFactory(BentoBox.getInstance()).withFirstPrompt(
				...
				withLocalEcho(false).
				withPrefix(context ->
					NumberGUI.this.user.getTranslation("biomes.gui.questions.prefix")).
