...
public class ConfirmationGUI
{
	...
	public void build()
	{
		PanelBuilder panelBuilder = new PanelBuilder().user(this.user).name(this.user.getTranslation("biomes.gui.title.admin.confirm-title"));
	...
	private PanelItem getButton(boolean returnValue)
	{
		return new PanelItemBuilder().
			name(this.user.getTranslation("biomes.gui.buttons.admin." + (returnValue ? "accept" : "decline"))).
