...
// ---------------------------------------------------------------------
    ...
    /**
     * This CustomPanelItem does no lose Item original MetaData. After PanelItem has been created it restores original
     * meta data. It also does not allow to change anything that could destroy meta data.
     */
    private static class CustomPanelItem extends PanelItem
    {
        /**
         * Instantiates a new Custom panel item.
         *
         * @param item the item
         */
